...
/*
	...
	Defines the jumps to all functions exported by the winmm.dll shared library.
*/
...
#ifndef _SP_DS1_FPS_FIX_PLUS_WINMM_H_
	#define _SP_DS1_FPS_FIX_PLUS_WINMM_H_


#ifdef _SP_WRAP_WINMM_DLL_


#define _SP_WRAPPED_LIB_ "winmm"
#define _SP_EXPORT_COUNT_ 193
...
#endif // _SP_DS1_FPS_FIX_PLUS_WINMM_H_
